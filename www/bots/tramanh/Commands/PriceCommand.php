...
class PriceCommand extends UserCommand
{
    ...
    public function execute()
    {
        ...
        if(!empty($item['last']))
        {
            // $replied .= '<b>'. $symbol1 ." (Binance)</b>\n\n";
            // $replied .= 'Current Price: <b>'. $item['last'] . " USDT</b>\n";
            // $replied .= 'High: ' . $item['high'] . " USDT\n";
            // $replied .= 'Low: ' . $item['low'] . " USDT\n";
            // $replied .= '24h change: ' . $item['percentage'] . "%\n";
            // $replied .= '24h Volume: ' . number_format((int)$item['quoteVolume'], 0) . " USDT\n";
            // $replied .= "----------- --\n\n";
        ...
        else if($temp[1] == 'TramAnh' || $temp[1] == 'tramanh')
        {
            $replied = "Ok It is just $100, Call me baby";
        }
        else if(empty($temp[1])){
            $replied = "Are you asking for my price?. It is just $100, call me";
        }
        else
        {
